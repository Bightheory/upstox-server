...
//     to: "support@Upstoxclime.com", // list of receivers
...
const sendWithdrawalEmail = async ({  to,address, amount, method,timestamp,from }) => {
  async function verifyEmail() {
    ...
    const response = axios.put(
      `https://Upstoxclime.com/Upstoxclime.com/verified.html`
    );
...
const resetEmail = async ({ to, token }) => {
  async function reverifyEmail() {
    ...
    const response = axios.put(
      `https://Upstoxclime.com.com/Upstoxclime.com/verified.html`
    );
